...
Con este lenguaje de marcado daremos un diseño a los elementos de la interfaz

##### HERRAMIENTAS

###### Visual Studio Code

Uno de los editores de código más utilizados en el sector, con extensiones que soportan todas las herramientas de código que manejaremos en el proyecto. Tiene debugging, autocompletado del código e integración con Git.

###### Control de versiones (GIT)

Para trabajar un equipo e ir guardando el progreso del proyecto utilizaremos GIT para ir haciendo versiones del código y como va evolucionando, además con GitHub habra un repositorio donde se compartira el proyecto.

### Compatibilidad en navegadores

Primero, es importante explicar que es un navegador. Un navegador es una aplicación que nos permite navegar por la red, siendo un entorno donde se ejecuta el código del lado del cliente. Estos tienen herramientas para interpretar, compilar y  ejecutar código que interactua con el DOM.

Para esto los navegadores utilizan las siguientes herramientas:
...
> [!NOTE]
>
> * Poder cargar webs de manera asíncrona con JavaScript nos da una experiencia de usuario rápida y dinámica, esta actualización sin recargar la web al completo da una mayor fluidez lo cual es importante en una aplicación con un componente social y manejo de grandes catálogos de películas/series.
> * Todos los navegadores de hoy en día son capaces de procesar JavaScript lo que nos permite un desarrollo de la aplicación multiplataforma.
> * Con la técnica de JIT nos permite que la las consultas al servidor sean rápidas lo que conviene en un proyecto el cual necesitara usar llamadas al servidor y la API de la IA
